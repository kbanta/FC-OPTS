                            ...
                            <table id="table3" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td class="pr_no_for_canvass">{{$forward->delivery_no}}</td>
                                        <td class="pr_purpose">{{$forward->order_no}}</td>
                                        <td class="pr_purpose">{{$forward->created_at}}</td>
                                        <td>
                                            @if(Auth::user()->hasRole('Approver'))
                                            <!-- <div class="btn btn-group"> -->
                                            <a href="{{route('view_forwardedd',[$dln = $forward->delivery_no,$po_no = $forward->po_no] )}}" class="btn btn-block btn-danger btn-sm view_btn"><i class="fa fa-eye"></i>View</a>
                                            <!-- <a href="{{route('track_forwarded_app',[$dln = $forward->delivery_no,$po_no = $forward->po_no] )}}" class="btn btn-success  btn-sm view_btn"><i class="fa fa-eye"></i>Track</a>
                                            </div> -->
                                            @endif
                                        </td>
                                    </tr>
                                ...
                                <tbody>
                                    <tr>
                                        ...
                                        <td width="15%">
                                            @if(Auth::user()->hasRole('Approver'))
                                            <!-- <div class="btn btn-group"> -->
                                            <a href="{{route('view_forwarded',[$dln = $ir->delivery_no,$po_no = $ir->po_no] )}}" class="btn btn-danger btn-block btn-sm view_btn"><i class="fa fa-eye"></i>View</a>
                                            <!-- <a href="{{route('track_forwarded_app',[$dln = $ir->delivery_no,$po_no = $ir->po_no] )}}" class="btn btn-success  btn-sm view_btn"><i class="fa fa-eye"></i>Track</a>
                                            </div> -->
                                            @endif
                                        </td>
                                    </tr>
